        ...
        <>
            ...
            <aside className={cn(
                ...
                <div className="p-6 border-b border-border/50 flex items-center justify-between">
                    <div>
                        <h2 className="text-lg font-bold text-text-primary">Owner Panel</h2>
                ...
                <div className="p-4 border-t border-border/50 flex flex-col gap-1">
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-text-secondary hover:bg-slate-50 hover:text-text-primary transition-colors text-left"
                    >
                        <LogOut className="w-5 h-5 shrink-0 text-text-secondary" />
                        <span>Logout</span>
                    </button>
                </div>
            </aside>
